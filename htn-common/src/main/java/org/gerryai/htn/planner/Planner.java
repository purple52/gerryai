 ...
 * @param <S> type of state this planner works with
 * @author David Edwards <david@more.fool.me.uk>
 */
public interface Planner<S extends State> {
	 ...
	 */
	Plan findPlan(S state, TaskNetwork taskNetwork) throws PlanNotFound;
