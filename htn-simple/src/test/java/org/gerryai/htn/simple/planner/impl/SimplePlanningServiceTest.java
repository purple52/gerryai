...
public class SimplePlanningServiceTest {
	...
	public void testSolvePlanFound() throws PlanNotFound {
		...
		Problem<SubstitutableOperator, SimpleMethod, SubstitutableTerm, SubstitutableTask, SubstitutableTaskNetwork,
		...
		@SuppressWarnings("unchecked")
		PlannerFactory<SubstitutableOperator, SimpleMethod, SubstitutableTerm, SubstitutableTask,
	...
	public void testSolvePlanNotFound() throws PlanNotFound {
		...
		Problem<SubstitutableOperator, SimpleMethod, SubstitutableTerm, SubstitutableTask, SubstitutableTaskNetwork, ValidatableConstraint<SubstitutableTerm,
		...
		@SuppressWarnings("unchecked")
		PlannerFactory<SubstitutableOperator, SimpleMethod, SubstitutableTerm, SubstitutableTask, SubstitutableTaskNetwork,
				ValidatableConstraint<SubstitutableTerm, SubstitutableTask, SubstitutableCondition>, SubstitutableCondition>
	 ...
	 */
	private Problem<SubstitutableOperator, SimpleMethod, SubstitutableTerm, SubstitutableTask, SubstitutableTaskNetwork,
