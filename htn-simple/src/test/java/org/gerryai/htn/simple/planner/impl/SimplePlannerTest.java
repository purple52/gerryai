...
public class SimplePlannerTest {
	...
	public void testEmptyProblem() throws PlanNotFound, NonPrimitiveTaskNotFound {
		...
		@SuppressWarnings("unchecked")
		PlannerHelper<SubstitutableOperator, SubstitutableMethod, SubstitutableTerm, SubstitutableTask, SubstitutableTaskNetwork,
		...
		@SuppressWarnings("unchecked")
		DomainHelper<SubstitutableOperator, SubstitutableMethod, SubstitutableTerm, SubstitutableTask, SubstitutableTaskNetwork,
		        ImmutableConstraint<?>, SubstitutableCondition>
	...
	public void testOneNonPrimitiveTask() throws NonPrimitiveTaskNotFound, PlanNotFound, DecompositionNotFound {
		...
		Set<SubstitutableTask> decomposedTasks = new HashSet<SubstitutableTask>();
