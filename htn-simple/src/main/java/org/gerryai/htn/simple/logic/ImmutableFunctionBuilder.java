 ...
 */
public interface ImmutableFunctionBuilder {
     ...
     */
    ImmutableFunctionBuilder setName(String name);
     ...
     * @return an updated builder
     */
    ImmutableFunctionBuilder addTerm(ImmutableTerm<?> term);
     ...
     * @return an updated builder
     */
    ImmutableFunctionBuilder addTerm(List<ImmutableTerm<?>> terms);
     ...
     */
    ImmutableFunctionBuilder copy(ImmutableFunction condition);
     ...
     * @return the updated builder
     */
    ImmutableFunctionBuilder apply(Map<ImmutableTerm<?>, ImmutableTerm<?>> substitution);
    
    /**
     * Build the condition.
     * @return the finished condition
     */
    ImmutableFunction build();
}
