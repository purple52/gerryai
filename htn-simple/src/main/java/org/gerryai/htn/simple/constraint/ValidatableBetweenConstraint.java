 ...
 *
 */
public interface ValidatableBetweenConstraint<T extends Term, K extends Task<T>, I extends Condition<T>>
		extends ValidatableConstraint<T, K, I>, BetweenConstraint<T, K, I> {
